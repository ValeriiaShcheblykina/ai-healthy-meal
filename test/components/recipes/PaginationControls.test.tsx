...
describe('PaginationControls', () => {
  ...
  describe('Edge Cases', () => {
    it('should handle very large page numbers', () => {
      ...
      expect(
        screen.getByRole('button', { name: 'Page 1000' })
      ).toBeInTheDocument();
    ...
    it('should handle single visible page in middle of large range', () => {
      ...
      expect(
        screen.getByRole('button', { name: 'Page 48' })
      ).toBeInTheDocument();
      expect(
        screen.getByRole('button', { name: 'Page 49' })
      ).toBeInTheDocument();
      expect(
        screen.getByRole('button', { name: 'Page 50' })
      ).toBeInTheDocument();
      expect(
        screen.getByRole('button', { name: 'Page 51' })
      ).toBeInTheDocument();
      expect(
        screen.getByRole('button', { name: 'Page 52' })
      ).toBeInTheDocument();
    });
